  ...
  const faqs = [
    {
      ...
      answer: "La première consultation est gratuite. Elle nous permet d'évaluer votre situation et de vous proposer un devis personnalisé adapté à vos besoins spécifiques. Nos tarifs sont transparents et compétitifs."
    },
    {
    ...
    },
    {
      ...
      answer: "Absolument ! Pour les urgences juridiques, nous offrons un service d'assistance 24/7. Vous pouvez nous joindre par téléphone, email ou WhatsApp. Nous nous engageons à répondre dans les plus brefs délais."
    },
    {
      question: "Travaillez-vous avec des entreprises ou uniquement des particuliers ?",
      answer: "Nous accompagnons aussi bien les particuliers que les entreprises (PME, startups, grandes entreprises). Nos services couvrent le droit des affaires, le droit du travail, les contrats commerciaux et bien plus encore."
    },
    {
      question: "Quelle est votre zone d'intervention géographique ?",
      answer: "Nous intervenons principalement au Bénin, avec un focus sur Cotonou et sa région. Toutefois, nous pouvons également traiter des dossiers dans d'autres villes du pays et même à l'international selon les besoins."
    },
    {
      question: "Comment garantissez-vous la confidentialité de mes informations ?",
      answer: "Le secret professionnel est au cœur de notre métier. Toutes vos informations sont strictement confidentielles et protégées. Nous utilisons des systèmes sécurisés et ne partageons jamais vos données sans votre consentement explicite."
    }
  ];
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Retrouvez les réponses aux questions les plus fréquentes sur nos services juridiques
          </p>
        </div>
